...
const CreateOrder = () => {
  ...
  const handleOrderSubmit = (e) => {
    ...
    const options = {
      ...
      body: JSON.stringify({
        ...productData,
        dropLatitude: productData.dropLocation.latitude,
        dropLongitude: productData.dropLocation.longitude,
        pickupLatitude: productData.pickupLocation.latitude,
        pickupLongitude: productData.pickupLocation.longitude,
    ...
    // /api/v1/orders
    fetch('http://localhost:8080/createOrder', options)
